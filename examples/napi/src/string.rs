...
#[napi]
pub fn create_external_latin1_empty<'env>(#[napi(env)] env: &'env Env) -> Result<JsString<'env>> {
...
#[napi]
pub fn test_latin1_methods(#[napi(env)] env: &Env, input: String) -> Result<Latin1MethodsResult> {
